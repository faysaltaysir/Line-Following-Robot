...
#define Ki 0.01
#define Kd 0.004  // experiment to determine this, slowly increase the speeds and adjust this value. ( Note: Kp < Kd)
#define thres 800
...
void setup() {
  ...
  qtr.setTypeRC();
  qtr.setSensorPins((const uint8_t[]){ 3,2,A0,A1,A2,A3,A4,A5,11,12 }, SensorCount);  //Declare the sensor pin with arduino
...
void loop() {
  ...
  //left 90 degree turn
  if ((a[0] == '1' && a[1] == '1' && a[2] == '1' && a[3] == '1') || (a[0] == '1' && a[1] == '1' && a[2] == '1') && a[9] == '0') {
    left_90();
  }
  //right 90 degree turn
  else if ((a[9] == '1' && a[8] == '1' && a[7] == '1' && a[6] == '1') || (a[0] == '1' && a[1] == '1' && a[2] == '1') && a[0] == '0') {
    right_90();
  }
  // else if ((a[9] == '1' && a[8] == '1' && a[7] == '1' && a[6] == '1') || (a[9] == '1' && a[8] == '1' && a[7] == '1') && a[0] == '0') {
  //   right_90();
  // }
  ...
  // Circle
  else if (a[0] == '0' && a[1] == '0' && a[2] == '0' && a[3] == '0' && a[5] == '0' && a[7] == '0' && a[8] == '0' && a[9] == '0') {
  ...
  //30 degree
    ...
    //RUN(2, 30, 1);delay(20);
    left_90();
  } else if ((a[9] == '1' || a[8] == '1') && (a[7] == '0' || a[6] == '0')) {
    // RUN(1, 30, 1);       //forward
    //RUN(2, 30, 1);delay(20);
    right_90();
  }
